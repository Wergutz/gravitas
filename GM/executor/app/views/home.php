...
<title>Frente de Serviço · GM SERVIÇOS</title>
...
<div class="phone">
  ...
  <div class="top">
    <div class="top-row">
      ...
      <div class="nm">GM SERVIÇOS<small>EXECUTOR</small></div>
      <div class="eq">
    ...
    <div class="equipes">
      ...
      <a href="<?= EXECUTOR_BASE ?>/?equipe=<?= (int)$eq['id'] ?>"
  ...
  <div class="scroll">
    ...
    <div class="info">
      <div class="info-h">
        ...
        <div>
          <b>Caminhamento</b>
          <span>toque no número para trocar de trecho</span>
        </div>
      </div>
      <div style="margin-top:10px">
        ...
        <div class="next">
          ...
          <a class="o troca<?= $ehAtual ? ' on' : '' ?>"
             ...
             title="Executar este trecho"><?= $tc['ordem'] ?></a>
          <?php endif; ?>
  ...
  <div class="footer">
    ...
    <a href="/GM/painel/alterar-senha.php" class="btn-sair" style="margin-right:6px">🔑 Senha</a>
