<?php
$empresa = defined('APP_CLIENT') ? APP_CLIENT : 'GM SERVIÇOS';
$uploadsBase = defined('EXECUTOR_UPLOADS') ? EXECUTOR_UPLOADS : '/GM/executor/uploads';
...
<div class="no-print">
  ...
  <a class="btn-voltar" href="/GM/master/?modo=dia&data=<?= htmlspecialchars($data) ?>">← Voltar</a>
</div>
...
?>
  <div class="fotos-grid">
    ...
    <?php /* O titulo da etapa e o CABECALHO da tabela da galeria: assim
             ele nunca fica sozinho no fim de uma pagina, separado das
             fotos, e ainda se repete quando a etapa continua na pagina
