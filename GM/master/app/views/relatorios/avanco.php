...
.no-print{display:none!important}body{padding:8px 12px}}
</style>
</head>
<body>
...
<div class="no-print">
  ...
  <a class="btn-voltar" href="/GM/master/?modo=periodo&inicio=<?= htmlspecialchars($inicio) ?>&fim=<?= htmlspecialchars($fim) ?>">← Voltar</a>
</div>
