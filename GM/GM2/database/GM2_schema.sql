-- =====================================================================
-- Schema do banco GM2 (GM SERVIÇOS)
-- =====================================================================
--
-- Este arquivo é um artefato de referência para criação do banco NOVO
-- `u278289683_GM2` (ainda não existe em produção). NÃO faz
...
-- citar o banco novo `u278289683_GM2`) e o acréscimo de
...
-- no dump real) — ver GM2_usuarios.sql para os usuários novos
