...
<head>
<meta charset="UTF-8">
<title>Relatório Oficial de Medição | GM SERVIÇOS</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">

<link rel="stylesheet" href="<?= mu_asset('/assets/css/planejador.css') ?>">
<link rel="stylesheet" href="<?= mu_asset('/assets/css/relatorio-gm.css') ?>">
</head>
...
<aside class="sidebar no-print">
    ...
    <nav>
        ...
        <a href="/GM/GM2/planejador/relatorio.php" class="active">📄 Relatório</a>
...
<thead><tr><td>
  <header class="mu-header">
    <img class="mu-logo" src="/GM/GM2/assets/img/icon-gm-full.png" alt="GM SERVIÇOS Urbanizadora">
