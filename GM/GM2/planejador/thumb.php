 ...
 *  Cliente : GM SERVIÇOS
 *  Página  : /GM/GM2/planejador/relatorio.php?planejamento_id=<id>
 ...
 *  Se um dia a GM subir centenas de fotos de uma vez e o primeiro
 ...
 * /GM/GM2/uploads/ com /GM/GM2/planejador/relatorio.php).
 * Se não for, rode o `check-ambiente.php` do doc 05 — ele imprime o caminho real.
 *
 * Exemplos possíveis, para referência:
 *   __DIR__ . '/../uploads'          -> /GM/GM2/uploads
 *   __DIR__ . '/uploads'             -> /GM/GM2/planejador/uploads
 *   '/home/USUARIO/public_html/GM/GM2/uploads'
 */
 ...
 *        #     ao DocumentRoot. Ex.: /GM/GM2/uploads/_thumbs
 *        RewriteCond %{QUERY_STRING} ^(?=.*(?:^|&)f=(croqui|foto)_([A-Za-z0-9._-]+))(?=.*(?:^|&)w=(220|440|560|880))
 *        RewriteRule ^thumb\.php$ /GM/GM2/uploads/_thumbs/%2%3.w%4.jpg [L,QSD]
 *      </IfModule>
 *
 ...
 *
 *      RewriteCond %{DOCUMENT_ROOT}/GM/GM2/uploads/_thumbs/%2%3.w%4.jpg -f
 *
