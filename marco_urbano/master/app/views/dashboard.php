...
<title>Visão Executiva · MARCO URBANO</title>
...
<aside class="sidebar">
  ...
  <circle cx="50" cy="50" r="5" fill="#3CB86A"/>
    ...
    <div><b>MARCO URBANO</b><small>VISÃO EXECUTIVA</small></div>
  </div>
  <nav class="nav">
    ...
    <a href="/marco_urbano/painel/alterar-senha.php">
      <?= svgIcon('<circle cx="8" cy="14" r="4.5"/><path d="M11.5 10.5 20 2m-3.5 1.5 3 3M14 8l2.5 2.5"/>') ?>
      Alterar Senha
    </a>
    <a href="/marco_urbano/painel/logout.php" class="sair">
