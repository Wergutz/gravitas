...
<!-- Capa -->
<div class="capa">
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Marco Urbano">
...
<div style="padding:32px 40px;color:var(--muted);font-size:11px;border-top:1px solid var(--line);margin-top:20px">
  MARCO URBANO · Relatório Fotográfico de Execução · Documento gerado automaticamente pelo sistema.
</div>
