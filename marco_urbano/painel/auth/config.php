...
const MU_BASE = '/marco_urbano/painel/';

// Sessão expira após 8h sem atividade
const MU_TEMPO_INATIVIDADE = 28800;

// Proteção contra força bruta
const MU_MAX_TENTATIVAS = 5;
const MU_BLOQUEIO_SEG   = 600; // 10 minutos

// "Manter conectado" — cookie válido por 30 dias
const MU_COOKIE_PERSISTENTE = 2592000;
...
$GV_USUARIOS = [
  'marco_urbano' => [
    'nome'   => 'Administrador Marco Urbano',
    'perfil' => 'empresa',
...
// ------------------------------------------------------------
function mu_sessao_iniciar() {
  if (session_status() === PHP_SESSION_ACTIVE) {
    return;
  }
  session_name('MUPAINEL');
