...
<title>Painel de Controle · MARCO URBANO</title>
<style>
  :root{
...
<div class="shell">
  ...
  <circle cx="50" cy="50" r="5" fill="#3CB86A"/>
      ...
      <span class="brand-name">MARCO URBANO</span>
    ...
    <div class="brand-foot">© 2026 Gravitas · Sistema operado por Marco Urbano Urbanizadora.</div>
  </aside>
  ...
  <main class="loginside">
    <div class="card">
      <div class="card-head">
        ...
        <p class="lede">Use as credenciais fornecidas pelo seu administrador para acessar o painel.</p>
      </div>
      ...
      <form id="form-login" method="post" action="<?= APP_BASE ?>/login.php" novalidate>
        ...
        <div class="row">
          <span></span>
          <a class="link" href="#" onclick="return false;">Esqueci minha senha</a>
        </div>
      ...
      <p class="help">Ainda não tem acesso? <a href="#">Falar com o suporte</a></p>
      <p class="legal">Ambiente seguro. Acesso restrito a usuários autorizados.</p>
    </div>
  </main>
</div>
