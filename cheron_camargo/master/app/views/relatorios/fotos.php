...
$uploadsBase = defined('EXECUTOR_UPLOADS') ? EXECUTOR_UPLOADS : '/cheron_camargo/executor/uploads';
...
<div class="no-print">
  ...
  <a class="btn-voltar" href="/cheron_camargo/master/?modo=dia&data=<?= htmlspecialchars($data) ?>">← Voltar</a>
</div>
