...
<head>
<meta charset="UTF-8">
<title>Vision Hub | Todos os Planejamentos</title>
...
<aside class="sidebar">
    ...
    <nav>
        ...
        <a href="/visionhub/planejamentos.php" class="active">📂 Todos os Planejamentos</a>
...
<?php endif; ?>
    ...
    <div>
        <h1>Todos os Planejamentos</h1>
        <span>Planejamentos ativos e finalizados</span>
    </div>
