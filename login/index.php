...
$sistemas = [
    ...
    [
        ...
        'alterar_senha' => '/CHERONCAMARGO/painel/alterar-senha.php',
        'destinos'    => [
            1 => '/CHERONCAMARGO/painel/',
            3 => '/CHERONCAMARGO/painel/',
            4 => '/CHERONCAMARGO/painel/',
            5 => '/CHERONCAMARGO/executor/',
            6 => '/CHERONCAMARGO/master/',
            7 => '/CHERONCAMARGO/executor-repav/',
            8 => '/CHERONCAMARGO/topografo/',
        ],
        'apps'        => [
            ['dest' => '/CHERONCAMARGO/painel/',        'label' => 'Planejador',              'sub' => 'Gestão, relatórios e diários'],
            ['dest' => '/CHERONCAMARGO/master/',         'label' => 'Visão Executiva',         'sub' => 'Dashboard do cliente master'],
            ['dest' => '/CHERONCAMARGO/executor/',       'label' => 'App do Executor',         'sub' => 'Frente de serviço em campo'],
            ['dest' => '/CHERONCAMARGO/executor-repav/', 'label' => 'Executor Repavimentação', 'sub' => 'Medição e controle de pavimento'],
    ...
    [
        ...
        'cookie_path' => '/GM/',
        'label'       => 'GM SERVIÇOS',
        'sub'         => 'Projetos e Construções',
        'alterar_senha' => '/GM/painel/alterar-senha.php',
        'destinos'    => [
            1 => '/GM/painel/',
            3 => '/GM/painel/',
            4 => '/GM/painel/',
        ...
        'apps'        => [
            ['dest' => '/GM/painel/',        'label' => 'Planejador',              'sub' => 'Gestão, relatórios e diários'],
            ['dest' => '/GM/master/',         'label' => 'Visão Executiva',         'sub' => 'Dashboard do cliente master'],
            ['dest' => '/GM/executor/',       'label' => 'App do Executor',         'sub' => 'Frente de serviço em campo'],
            ['dest' => '/GM/executor-repav/', 'label' => 'Executor Repavimentação', 'sub' => 'Medição e controle de pavimento'],
            ['dest' => '/GM/topografo/',      'label' => 'Topógrafo',               'sub' => 'Importação e OS de topografia'],
        ],
    ],
];
