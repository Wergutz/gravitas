<?php
$empresa = defined('APP_CLIENT') ? APP_CLIENT : 'BACIN';
$uploadsBase = defined('EXECUTOR_UPLOADS') ? EXECUTOR_UPLOADS : '/BACIN/executor/uploads';
...
<div class="no-print">
  ...
  <a class="btn-voltar" href="/BACIN/master/?modo=dia&data=<?= htmlspecialchars($data) ?>">← Voltar</a>
</div>
